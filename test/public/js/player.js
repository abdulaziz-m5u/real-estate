...
(function (root, factory) {
    ...
    lunar.toggleClass = function (elem, name) {
        lunar[lunar.hasClass(elem, name) ? "removeClass" : "addClass"](
            elem,
            name
        );
    };
...
(function ($) {
    var _ = {
        cursorPoint: function (evt, el) {
            ...
            return _.settings.pt.matrixTransform(
                playObject.getScreenCTM().inverse()
            );
        },
            ...
            $(_.settings.controlsObj).on("click", function (e) {
                ...
                switch (obj.class.replace("playable", "").trim()) {
                    case "not-started":
                        ...
                        var audioId = document.getElementById(
                            obj.activeAudio.attr("id")
                        );
    ...
    $.fn.mediaPlayer = function (methodOrOptions) {
        if (_[methodOrOptions]) {
            ...
            $.error(
                "Method " +
                    methodOrOptions +
                    " does not exist on jQuery.mediaPlayer"
            );
        }
    };
})(jQuery);
