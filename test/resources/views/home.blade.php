...
@section('content')
    <div class="slide-one-item home-slider owl-carousel">
        @foreach ($featuredVenues as $featuredVenue)
            <div class="site-blocks-cover" style="background-size: cover;background-repeat: no-repeat;background-image: url('{{ $featuredVenue->getFirstMediaUrl('main_photo') }}');"
                ...
                <div class="nonloop-block-13 owl-carousel">
                    ...
                    <div class="slide-item">
                        <div class="team-member text-center">
                            <a href="">
                                <img src="" alt="{{ $location->name }}" class="img-fluid mb-4 w-50 rounded-circle mx-auto">
                            </a>
                            <div class="text p-3">
                                <a href="">
